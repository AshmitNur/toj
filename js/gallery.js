...
function initShowcaseGallery() {
  ...
  style="position: absolute; top: 40px; right: 40px; background: none; border: 0; color: #fff; font-size: 3rem; cursor: pointer; transition: color 0.3s; z-index: 1010;">
  &times;
</button>

<button class="lightbox-nav lightbox-prev" aria-label="Previous Image"
  style="position: absolute; left: 40px; top: 50%; transform: translateY(-50%); background: none; border: 0; color: #fff; font-size: 2.5rem; cursor: pointer; transition: color 0.3s; z-index: 1010;">
  &larr;
</button>

<button class="lightbox-nav lightbox-next" aria-label="Next Image"
  style="position: absolute; right: 40px; top: 50%; transform: translateY(-50%); background: none; border: 0; color: #fff; font-size: 2.5rem; cursor: pointer; transition: color 0.3s; z-index: 1010;">
  &rarr;
</button>
      </div>
    `;
